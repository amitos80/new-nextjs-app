...
const H2 = (props) => {
  const { children, className, background = 'transparent', fontSize = '14px', position = 'relative', opacity = 1, ellipsis, marquee,
    ...
    fontWeight = '500', minHeight, textShadow, fontStyle, lineHeight, color, top, left, bottom, right,  uppercase, onClick, textTransform } = props;

  return (
    <h4 className={classNames(className, 'h4')} onClick={onClick}>
      {children}
      <style jsx>{`
            .h4 {
