...
const H3 = (props) => {
  const { children, className, background = 'transparent', fontSize = '14px', position = 'relative', opacity = 1, ellipsis, marquee,
    ...
    fontWeight = '300', minHeight, textShadow, fontStyle, lineHeight, color, top, left, bottom, right,  uppercase, onClick, textTransform } = props;

  return (
    <h3 className={classNames(className, 'h3')} onClick={onClick}>
      {children}
      <style jsx>{`
            .h3 {
